...
skip_words = ['a', 'about', 'all', 'an', 'another', 'any', 'around', 'at',
              ...
              'of', 'off', 'oh', 'on', 'please', 'small', 'some', 'soon', 'student',
              'that', 'the', 'then', 'this', 'those', 'through', 'to',
              'until', 'us', 'want', 'we', 'what', 'when', 'why',
              'wish', 'with', 'would']
...
def normalise_input(user_input):
    ...
    words_list = no_spaces.split()
    actions = filter_words(words_list, skip_words)
    return actions
