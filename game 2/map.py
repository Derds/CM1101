...
Queen's Buildings.""",
    ...
    "exits": {"west": "Parking", "towards": "Secret"},
...
game_end = {
    ...
    "description":
    """YOU HAVE WON. As much as it is possible to win... You may continue to explore but there is little else to gain. Thank you for playing the game. I hope you feel dignified and content""",
